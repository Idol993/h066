...
<div class="container">
    ...
    {summary_html}
    <div class="tabs">
        <button class="tab active" onclick="switchTab(event, 'waterfall')">Waterfall</button>
        <button class="tab" onclick="switchTab(event, 'flame')">Flame Graph</button>
        <button class="tab" onclick="switchTab(event, 'timeline')">Timeline</button>
    </div>
    <div id="waterfall" class="tab-content active">
        <div class="chart-container">
            <h2>Waterfall Chart - Span Call Chain</h2>
            {waterfall_html}
        </div>
    </div>
    <div id="flame" class="tab-content">
        <div class="chart-container">
            <h2>Flame Graph - Latency Overview</h2>
            {flame_html}
        </div>
    </div>
    <div id="timeline" class="tab-content">
        <div class="chart-container">
            <h2>Timeline View - All Spans by Service</h2>
            {timeline_html}
        </div>
    </div>
</div>
